...
function About(){
    return (
        ...
        <div className='homepagecontainersignedout'>
            <div className='homepagesignedoutleftabout'>
                <h2 className='homepageh2signedoutabout'>About.</h2>
                <p className='homepagepsignedout'>Resources for Artists Everywhere looks to offer artists a space to communicate and share resources.</p>
