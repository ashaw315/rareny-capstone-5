...
function UserAccount({ user }){
    ...
    function handleUpdateAccount(e) {
        ...
        setAccountUpdatedNote('Account updated.')
    };
                ...
                <div className='accountformcontainer'>
                    <form onSubmit={handleUpdateAccount}>
                        ...
                        <div className='accountinputdiv'>
                            ...
                            <input className='accountinput' value={updatedAccount.username} onChange={(e) => handleUpdate(e, 'username')}></input>
                        </div>
                        <div className='accountinputdiv'>
                        ...
                        <div className='accountinputdiv'>
                            ...
                            <input className='accountinput' value={updatedAccount.website} onChange={(e) => handleUpdate(e, 'website')}></input>
                        </div>
                        <div className='accountinputdiv'>
                            <p className='accountp'>Discipline</p>
                            <input className='accountinput' value={updatedAccount.discipline} onChange={(e) => handleUpdate(e, 'discipline')}></input>
                        </div>
                        <div className='accountinputdiv'>
